...
\begin{frame}{Data Model}
  \begin{itemize}
    ...
    \item Environment fields:
      \begin{itemize}
        \item \texttt{bandwidth}, \texttt{latency}, \texttt{weight\_latency}, \texttt{latency\_limit}.
      \end{itemize}
...
\begin{frame}{GUI Workflow}
  \begin{enumerate}
    ...
    \item Configure bandwidth, latency, objective weight, solver mode, iterations, and E2E cap.
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.5\textwidth}
      ...
      \begin{itemize}
        ...
        \item Transfer bars use network transfer duration.
